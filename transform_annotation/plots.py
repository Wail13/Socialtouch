...
selected_stimulus=['hug2_p', 'hug3_p', 'str1_p', 'str2_p', 'tap1_neu', 'sha1_n', 'sha2_n', 'slap1_n']
...
im, cbar = heatmap(d2, selected_stimulus, ['Hand','foreA','Arm','Should','Chest','Abs','upback','lwback'], ax=ax,
                   cmap="YlGn", cbarlabel="Annotators mean vote")
